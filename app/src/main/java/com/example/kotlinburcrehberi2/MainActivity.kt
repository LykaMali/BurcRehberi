...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var tumBurcBilgileri:ArrayList<Burclar>
    ...
    private fun veriKaynagiHazirla() {
        tumBurcBilgileri= ArrayList<Burclar>(12)
